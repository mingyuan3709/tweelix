...
public final class CardinalDirectionFeature {
    ...
    // ==================== 渲染方法 ====================
    public static void drawDirectionLabel(GuiGraphicsExtractor instance, Font font, TrackedWaypoint waypoint,
        ...
        instance.centeredText(font, direction, 0, -font.lineHeight / 2, textColor);
        pose.popMatrix();
    }
}